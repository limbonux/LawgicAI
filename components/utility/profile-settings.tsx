    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <div className="grow overflow-auto">
          ...
          <Tabs defaultValue="profile" className="pl-4">
            <TabsList dir="rtl" className="mt-4 grid w-full grid-cols-1">
            ...
            <TabsContent className="mt-4 space-y-4" value="profile">
              ...
              <div className="space-y-1" dir="rtl">
                ...
                <Input
                  placeholder="الاسم الظاهر في الدردشة.."
                  value={displayName}
              ...
              <div className="space-y-1" dir="rtl">
                <Label className="text-sm">
                  ما الذي تريد أن يعرفه الذكاء الاصطناعي عنك لتقديم إجابات أفضل؟
                </Label>

                <TextareaAutosize
                  value={profileInstructions}
                  onValueChange={setProfileInstructions}
                  placeholder="السياق العام للملف الشخصي... (اختياري)"
                  minRows={6}
                  maxRows={10}
                />
                  ...
                  <>
                    {envKeyMap["openai"] ? (
                      ...
                      <Input
                        ...
                        type="password"
                        value="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"
                        // {openaiAPIKey}
                      ...
                      {envKeyMap["openai_organization_id"] ? (
                        ...
                        <>
                          ...
                          <Input
                            ...
                            type="password"
                            value="proj_2jGjoviTulOtQDw07AezwJXI"
                            // {openaiOrgID}
        ...
        <div className="mt-6 flex items-center">
          <div className="flex items-center space-x-1">
            ...
            <WithTooltip
              display={
                <div>
                  تنزيل بيانات LawgicAI بصيغة JSON. ميزة الاستيراد قريبًا!
                </div>
              }
              trigger={
                <IconFileDownload
