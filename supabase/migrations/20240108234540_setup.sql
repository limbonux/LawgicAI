...
AS $$
DECLARE
  project_url TEXT := 'https://omrmzuxrfvmahtykcowz.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9tcm16dXhyZnZtYWh0eWtjb3d6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0MTM5MzQwNiwiZXhwIjoyMDU2OTY5NDA2fQ.rMKYshw596Z1v3sd8z4b5idrNBOXHSiZF8ypca5y-W8'; -- full access needed for http request to storage
